...
DUNGEONS = {
    ...
    "taixu": {
        "name": "太虚天门", "realm": 4, "layers": 5, "stamina": 60, "entry_stone": 1800,
        "daily_limit": 2,
        "stone": (900, 1500), "cult": 2400,
        "mobs": [
            _mob("太虚天兵", 46000, 5400, 2500, 720, 260, ("普攻", "快剑斩")),
            _mob("虚空灵将", 52000, 5850, 2700, 760, 280, ("普攻", "烈火诀", "金钟罩")),
        ],
        "boss": _mob(
            "太虚门主", 135000, 8400, 4200, 980, 360,
            ("普攻", "快剑斩", "烈火诀", "金钟罩")),
        "drops": [
            ("化神丹残方", 25, 1, 2),
            ("星陨砂", 55, 2, 4),
